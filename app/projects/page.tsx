                ...
                <ul className='grid grid-cols-1 gap-x-12 gap-y-16 sm:grid-cols-2 lg:grid-cols-3'>
                    {projects.map(project => (
                        <li key={project.name} className='group relative flex flex-col items-start'>
                            <div className='relative z-10 flex h-12 w-12 items-center justify-center rounded-full bg-white shadow-md shadow-zinc-800/5 ring-1 ring-zinc-900/5 dark:border dark:border-zinc-700/50 dark:bg-zinc-800 dark:ring-0 mb-3 group-hover:bg-blue-500 '>
                            ...
                            <h2 className='text-base font-semibold tracking-tight text-zinc-800 dark:text-zinc-100 group-hover:text-gray-800 dark:group-hover:text-gray-100'>
                                ...
                                <Link href={project.link.href} className=''>
